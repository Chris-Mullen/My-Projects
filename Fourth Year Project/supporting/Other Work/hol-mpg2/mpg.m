function mpg
	...
	system("ffmpeg -i tmp/frame%d.png -qmax 1 mpg-out/out.mp4");
	system("ffmpeg -i tmp/frame%d.png -qmax 1 mpg-out/out.avi");
	system("ffmpeg -i tmp/frame%d.png -qmax 1 mpg-out/out.mpg");
